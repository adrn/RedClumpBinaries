...
for i in range(len(opts)):
    ...
    for j in range(len(opts[i])):
        ...
        data_x, data_y, data_yerr, _ = bin_f_binary_in_logg(metadata, binaries_mask, metal_mass_mask, logg_bins)
        ...
        fr_fits[-1].append((metal_low,metal_high,mass_low,mass_high,metal_mass_mask,slope,offset,samples))
